...
const cashierMenuItems = [
    { id: 'tables',    text: 'Quản Lý Bàn', icon: 'fa-border-all',          link: 'tables' },
    { id: 'invoices',  text: 'Hóa Đơn',     icon: 'fa-file-invoice-dollar', link: 'invoices' },
    { id: 'payment',   text: 'Thanh Toán',  icon: 'fa-credit-card',         link: 'payment' }
];
