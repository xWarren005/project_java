...
public class BookingStatusActivity extends AppCompatActivity {
    ...
    private TextView tvBookingId, tvRestaurant, tvTime, tvGuest, tvStatus, tvNote;
    ...
    private void bindBooking(Booking b) {
        ...
        // Nếu backend chưa trả restaurantName thì sẽ rỗng
        if (tvRestaurant != null) {
            String name = b.getRestaurantName();
            tvRestaurant.setText((name == null || name.trim().isEmpty()) ? "Nhà hàng #" + b.getRestaurantId() : name);
        }
